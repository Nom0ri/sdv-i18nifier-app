import{_ as u,o as t,c as n,a as o,t as d,F as l,h as c,e as a,r as k,g as x,n as y}from"./404-314a05a4.js";const v={props:{section:{type:Object,required:!0},isConfigPage:{type:Boolean,default:!1}}},T={class:"mb-6"},b={class:"text-2xl mb-6"},_=["innerHTML"],P=o("p",{class:"text-xl space"},"Notes:",-1),C=["innerHTML"],N={class:"howtotextareas"},w={class:"input-container left"},E=["value"],I=["value"],D=["value"],M=["value"],W={key:0,class:"input-container right"},R=["value"],S=["value"],A={key:1,class:"input-container right"},J=["value"];function j(m,p,e,h,i,f){return t(),n("div",T,[o("p",b,[o("strong",null,d(e.section.title),1)]),(t(!0),n(l,null,c(e.section.descriptions,s=>(t(),n("p",{class:"text-lg",key:s,innerHTML:s},null,8,_))),128)),e.section.notes?(t(),n(l,{key:0},[P,(t(!0),n(l,null,c(e.section.notes,s=>(t(),n("p",{class:"text-lg",key:s,innerHTML:s},null,8,C))),128))],64)):a("",!0),o("div",N,[o("div",w,[o("textarea",{class:"input-field hide-scroll",placeholder:"Input entry",readonly:"",value:e.section.inputText},null,8,E),e.section.customToken?(t(),n("input",{key:0,class:"prefix-field",type:"text",placeholder:"Custom Token (Empty)",value:e.section.customToken.model,readonly:""},null,8,I)):a("",!0),e.section.customPrefix?(t(),n("input",{key:1,class:"prefix-field",type:"text",placeholder:"Custom Prefix (Empty)",value:e.section.customPrefix.model,readonly:""},null,8,D)):a("",!0),e.section.customImportToken?(t(),n("input",{key:2,class:"prefix-field",type:"text",placeholder:"Custom Import Token (Empty)",value:e.section.customImportToken.model,readonly:""},null,8,M)):a("",!0)]),e.isConfigPage?a("",!0):(t(),n("div",W,[o("textarea",{class:"input-field button-padding hide-scroll",placeholder:"Content.json",readonly:"",value:e.section.contentText},null,8,R),o("textarea",{class:"input-field button-padding hide-scroll",placeholder:"i18n",readonly:"",value:e.section.i18nText},null,8,S)])),e.isConfigPage?(t(),n("div",A,[o("textarea",{class:"input-field button-padding hide-scroll",placeholder:"i18n",readonly:"",value:e.section.i18nText},null,8,J)])):a("",!0)])])}const Q=u(v,[["render",j]]),B={components:{SectionComponent:Q},data(){return{activeTab:0,sections:[{title:"Dialogues",descriptions:["Works with dialogues, mails and random dialogue.","You can set 'custom prefix', which makes resulting i18n much more readable and easier to manage."],notes:["Random dialogues must be converted one at a time; regular can be converted en masse.","Mails need to have titles.","Import Token is used for importing tokens into i18n (very specific use cases)"],inputText:`Input Entry
...
"Wild_Bait.DisplayName": "",`,customToken:{model:""}},{title:"Furniture",descriptions:["Works with slash delimited furniture data.","&nbsp;"],notes:["Works on multiple entries at once.",'If there are spaces in the English name, they will be replaced with "_" in the tokens.'],inputText:`"0": "Oak Chair/chair/-1/-1/4/350/-1/Oak Chair",
"3": "Walnut Chair/chair/-1/-1/4/350/-1/Walnut Chair/index",`,contentText:`"0": "Oak Chair/chair/-1/-1/4/350/-1/{{i18n:0.DisplayName}}",
"3": "Walnut Chair/chair/-1/-1/4/350/-1/{{i18n:3.DisplayName}}/index",`,i18nText:`"0.DisplayName": "Oak Chair",
"3.DisplayName": "Walnut Chair",`,customToken:{model:""}},{title:"Gift Tastes",descriptions:["Works with reactions for Gift Tastes","&nbsp;"],notes:["Works on multiple entries at once.","If the entry includes {{ModId}} in the ID, it will be skipped for i18n keys.","&nbsp;"],inputText:`"{{ModId}}_Example": "Reaction love/66/Reaction like//Reaction dislike/-5/Reaction hate/330/Reaction neutral//",
...
"config.section.Appearance.description": "",`,customField:null,isConfigPage:!0}]}}},O={class:"text-white text-center home"},q={class:"tab-navigation"},H=["onClick"];function L(m,p,e,h,i,f){const s=k("SectionComponent");return t(),n("div",O,[o("div",q,[(t(!0),n(l,null,c(i.sections,(g,r)=>(t(),n("button",{key:r,class:y(["tab-button",{active:i.activeTab===r}]),onClick:F=>i.activeTab=r},d(g.title),11,H))),128))]),i.sections[i.activeTab]?(t(),x(s,{key:0,section:i.sections[i.activeTab],isConfigPage:i.sections[i.activeTab].isConfigPage},null,8,["section","isConfigPage"])):a("",!0)])}const G=u(B,[["render",L]]);export{G as default};
